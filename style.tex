...
\setlist[enumerate,2]{rightmargin=.25in}

% Diagrams
\def\diagram#1#2{\list{}{\leftmargin#1\rightmargin#2}\item[]}
\let\enddiagram=\endlist
...
% Induction
\newenvironment{basecase}{\vspace*{-11pt}\list{}{\leftmargin.25in}\item{\textit{Base Case}:}}{\endlist\vspace*{-6pt}}
\newenvironment{induction}{\vspace*{-11pt}\list{}{\leftmargin.25in}\item{\textit{Inductive Step}:}}{\endlist\vspace*{-12pt}}
